...
int main(int argc, char* argv[]) {
    ...
    std::cout << configMap["hidden_size"] << std::endl;
...
//     read_image_as_batch(test_image_path, test_images_batched, test_image_size, 1);
//     std::cout << test_image_size << std::endl;
//     std::cout << test_images_batched.size() << std::endl;
...
//     std::string log_path = "log_predictions.txt";
...
//                 }
//             }
//             out << " - image " << image_idx << ": " << "Predicted=" << predicted << "." << " Label=" << real << std::endl;
//             std::cout << " - image " << image_idx << ": " << "Predicted=" << predicted << "." << " Label=" << real << std::endl;
//         }
//     }
//}